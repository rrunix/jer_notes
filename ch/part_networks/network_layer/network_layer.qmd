...
- **plano de datos**: ejecuta el proceso de reenvio mediante hardware especializado para máxima eficiencia. La parte de puertos de entrada, puertos de salida y fabric de conmutación formarían parte del plano de control.

...
acronyms:
  keys:
    - shortname: LAN
      longname: redes de área local (del inglés Local Area Network)
    - shortname: WAN
      longname: redes de área ancha (del inglés Wide Area Network)
    - shortname: RTT
      longname: tiempo de ida y vuelta (del inglés round-trip time)
---

...
Como ejemplo, vamos a ver los pasos para el envio de un mensaje desde A a C. Podéis ver la representación en un diagrama de secuencia en la @fig-example-access-layer. Los pasos serían los siguientes:
...
```
Ejemplo de envio de paquetes en una red local donde no se conoce la MAC del destinatario.
:::

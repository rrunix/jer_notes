...
El capítulo se divide en un apartado donde veremos las principales funciones de la red y después veremos los protocolos definidos en esta capa. Para guiar el aprendizaje, antes veremos un ejemplo del funcionamiento de la Capa de Acceso a Red. No os preocupéis si no entendéis por ahora todos los conceptos, las conceptos los iremos viendo a lo largo de este capítulo.
...
```
Ejemplo de envío de paquetes en una red local donde no se conoce la MAC del destinatario.
:::
...
Los **media converters** facilitan la interoperabilidad convirtiendo entre diferentes medios físicos como fibra óptica y cobre, adaptando automáticamente velocidades, y permitiendo extensión de redes existentes o migración gradual a tecnologías más avanzadas. 
...
| **Access Points** | Conectividad inalámbrica | CSMA/CA, traducción cableado-wireless, beamforming | Redes Wi-Fi empresariales |
...
```
Cabeceras de un paquete de Ethernet.
:::
...
```
Cabeceras de un paquete Wi-Fi
:::

Al igual que en Ethernet, la evolución de Wi-Fi ha sido enorme. Los primeros estándares, 802.11n (Wi-Fi 4), contaban con velocidades de hasta 600 Mbps hasta Wi-Fi 7 (802.11be) promete hasta 46 Gbps. Las mejoras se han enfocado en técnicas para reducir interferencias entre redes y colisiones entre dispositivos, y la inclusión de más bandas:
